class Deferreason < ActiveRecord::Migration[5.1]
  def change
    # Rename
    rename_column :deferreason, :deferreason_id, :id

    rename_column :deferreason, :deferreason_name, :name
    rename_column :deferreason, :deferreason_description, :description

    # Timestamps
    model_name = "deferreason"
    ...
    # Tablename
    rename_table :deferreason, :defer_reasons
  end
end
