...
class FeatureFlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature_flag" do
    assert_difference('FeatureFlag.count') do
      post feature_flags_url, params: { feature_flag: { enabled: true , name: "Demo Feature" } }
    end
  ...
  test "should update feature_flag" do
    patch feature_flag_url(@feature_flag), params: { feature_flag: { enabled: @feature_flag.enabled, name: @feature_flag.name } }
